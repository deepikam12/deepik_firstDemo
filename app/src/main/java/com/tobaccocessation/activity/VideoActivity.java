...
import com.tobaccocessation.Utils.BuildConfig;
import com.tobaccocessation.Utils.CameraCapturerCompat;
...
import com.tobaccocessation.dialog.Dialog;
...
//            setAccessToken();
            // connectToRoom(notificationModel.getRoomName());
        }
//        Timer t = new Timer(false);
//        t.schedule(new TimerTask() {
//            @Override
//            public void run() {
//                callServiceToDisconnectWedside();
//
//            }
//        }, 5000);
    ...
    private void callServiceToDisconnectWedside() {
...
//                getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
    ...
    private void callServiceToDisconnectUserSide() {
        if (Utils.isConnectingToInternet(this)) {
            try {
                ...
                jsonObject.put("coach_id", notificationModel.getCoach_id());
                jsonObject.put("roomname", notificationModel.getRoomName());

                JsonObjectRequest dashboardRequest = new JsonObjectRequest(Request.Method.POST, Urls.BASE_URL + Urls.DisconnectCall, jsonObject,
                        new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                try {
...
//    }
    ...
    private void connectToRoom(String roomName) {
        configureAudio(true);
        ConnectOptions.Builder connectOptionsBuilder = new ConnectOptions.Builder(notificationModel.getAccessToken_video());
...
//                R.drawable.ic_video_call_white_24dp));
    ...
    private void setDisconnectAction() {
        connectActionFab.setBackgroundTintList(ColorStateList.valueOf(Color
                .parseColor("#cf2a27")));
        connectActionFab.setImageDrawable(ContextCompat.getDrawable(this,
        ...
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
               ...
               // connectActionFab.setVisibility(View.VISIBLE);
                //   connectActionFab.
                //videoStatusTextView.setText("Connected to " + notificationModel.getRoomName());
                // setTitle(room.getName());

                setTitle(notificationModel.getRoomName());
            ...
            public void onDisconnected(Room room, TwilioException e) {
                localParticipant = null;
                 finish();
                //  videoStatusTextView.setText("Disconnected from " + notificationModel.getRoomName());
    ...
    private View.OnClickListener disconnectClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //callServiceToDisconnectUserSide();
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (localAudioTrack != null) {
                    ...
                    int icon = enable ?
                            R.drawable.unmute : R.drawable.mute;
